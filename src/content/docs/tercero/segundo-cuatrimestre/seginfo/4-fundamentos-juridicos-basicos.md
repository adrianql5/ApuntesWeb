---
title: "Fundamentos jurídicos básicos"
---

# 4.0 De la dictadura a la Constitución

La **Transición española** fue el proceso por el que se pasó del sistema franquista al sistema constitucional actual. La idea clave es que el cambio se hizo **desde dentro del propio régimen anterior**, desmontando su estructura jurídica de forma gradual.
...
El **art. 1.1 CE** define a España como un **Estado social y democrático de Derecho**. Esa fórmula reúne tres ideas distintas:

- **Estado social**: el Estado no solo debe abstenerse de intervenir, sino también promover condiciones de vida dignas. Esto se refleja en sanidad, educación, vivienda, familia, Seguridad Social o medio ambiente.
...
- Los **principios rectores** orientan al legislador, a los jueces y a toda la actuación de los poderes públicos.
- **No son tan directamente exigibles** como los derechos fundamentales.
...
El **art. 9.3 CE** recoge garantías esenciales:

- **Principio de legalidad**: solo se puede actuar o sancionar conforme a Derecho.
- **Jerarquía normativa**: las normas se ordenan por rango. La regla básica es **Constitución > leyes > reglamentos**.
...
- **Vacatio legis**: tiempo entre la publicación de una norma y su entrada en vigor. Como regla general, son **20 días** si la propia norma no dispone otra cosa.
...
- **Generalizada**.
- Acompañada de la convicción de obligatoriedad jurídica, la llamada **`opinio iuris`**.
...
- Aplicarse en defecto de ley y costumbre.
- Interpretar normas.
- Rellenar lagunas jurídicas.
...
- **Jerárquica**: está por encima de toda norma inferior.
...
- Requiere **mayoría absoluta del Congreso** en la votación final sobre el conjunto del texto.
- **Mayoría absoluta** significa la mitad más uno del número total de diputados, no solo de los presentes.
- Regula materias especialmente importantes:
...
- Regula las materias no reservadas a ley orgánica.
...
- El Congreso puede además tramitarlo como **proyecto de ley por el procedimiento de urgencia**.
- No puede afectar a materias vedadas por la Constitución, como:
...
No debe confundirse un **texto refundido** con una **ley ómnibus**: el refundido integra o aclara normas previas, mientras que la ley ómnibus mezcla reformas de materias diversas en una misma ley.
...
- **Directiva 95/46/CE**: antecedente europeo en protección de datos, luego superada por el RGPD.
- **Reglamento (UE) 2016/679**: **RGPD**, de aplicación directa.
- **Directiva 2016/680**: protección de datos en el ámbito penal; exige transposición.
- **Convenio 108 del Consejo de Europa**: antecedente internacional importante, aunque **no es Derecho de la UE**.

También conviene no confundir:

- **Consejo de la UE**: institución de la UE que participa en la adopción de legislación.
...
- El **Congreso** y el **Senado**, mediante **proposiciones de ley**.
- Las **asambleas legislativas autonómicas**.
- La ciudadanía, mediante **iniciativa legislativa popular**, con **500.000 firmas**.

La **iniciativa legislativa popular** no puede referirse a materias:
...
La diferencia entre **proyecto de ley** y **proposición de ley** es quién lo presenta:
