---
title: "Test parte jurídica y protección de datos (TeoríaSegInfo p. 18+)"
---
...
12. ¿Cuál no es un principio de protección de datos?
...
13. El tratamiento de datos personales en investigación penal:
...
14. ¿A qué se dedica el delegado de protección de datos?
...
15. El tratamiento de datos por la policía con fines administrativos no penales se rige por:
...
16. ¿La agenda de un alto cargo debe ser pública?
   - a) Sí, siempre
   - b) No
...
18. Como Policía Local, si un vecino denuncia una cámara enfocando a la vía pública:
...
19. Si un alto cargo tiene una reunión con representantes de un colectivo LGTBI:
   - a) Debe hacerse referencia al representante y a la asociación
...
20. El nivel de seguridad en protección de datos:
...
21. La normativa de protección de datos exige que los responsables:
...
22. El principio de minimización de datos implica que:
...
23. El tratamiento de datos en investigaciones penales está regulado a nivel europeo en:
...
24. En cuanto a categorías especiales de datos, señala la incorrecta:
   - a) Nunca se pueden tratar
   - b) El iris es categoría especial
   - c) Incluyen datos genéticos, biométricos o de salud
   - Respuesta: `a)`.

25. Entre los principios de utilización de videocámaras por Fuerzas y Cuerpos de Seguridad se encuentra:
...
26. La seguridad de los datos personales:
...
27. ¿Quién es el encargado del tratamiento?
...
28. ¿Puede un Policía Local fotografiar el DNI de un ciudadano?
   - a) Sí, siempre
...
29. El tratamiento de datos es lícito si hay:
...
30. Los derechos de los interesados en protección de datos:
...
31. En el caso de la Xunta de Galicia, el encargado del tratamiento es:
...
32. Si un alto cargo tiene una reunión con representantes de un colectivo LGTBI que sale todos los días en la TVG porque es el presentador de las noticias:
...
33. La protección de datos como derecho fundamental significa que:
...
34. Los delegados de protección de datos tienen como función:
...
35. La videovigilancia afecta a la protección de datos:
...
36. En el seno de la actividad administrativa:
...
37. ¿Cuál es la base legal más común para el tratamiento de datos personales en el sector público?
...
11. ¿Qué derecho evita decisiones basadas únicamente en tratamiento automatizado?
   - a) Portabilidad
   - b) Oposición
...
12. Sobre el consentimiento según el RGPD:
...
13. ¿Qué exige la privacidad desde el diseño?
...
14. ¿Plazo máximo general para atender derechos ARSULIPO?
   - a) 10 días hábiles
   - b) 30 días naturales
   - c) 1 mes
   - d) 90 días
...
15. ¿Qué datos están especialmente protegidos?
...
16. ¿Qué principio limita el tiempo de conservación?
   - a) Exactitud
...
17. ¿Qué derecho permite recibir una copia en formato estructurado y de uso común?
   - a) Acceso
   - b) Oposición
   - c) Portabilidad
   - d) Rectificación
...
18. ¿Qué base jurídica NO reconoce el RGPD?
   - a) Interés legítimo
...
19. ¿Qué principio implica que el responsable debe poder demostrar cumplimiento?
   - a) Confidencialidad
...
20. ¿Qué norma complementa al RGPD en España?
   - a) LSSI
   - b) LOPDGDD
...
21. ¿Quién debe aplicar medidas técnicas y organizativas para cumplir el RGPD?
   - a) DPD
   - b) Encargado
   - c) Responsable
   - d) AEPD
...
24. ¿Qué autoridad controla la protección de datos en España?
...
25. ¿Cuál no es un derecho reconocido por el RGPD?
   - a) Derecho al olvido
...
26. ¿Para qué sirve la anonimización?
...
27. ¿Cuándo es obligatorio designar un DPD?
...
28. ¿Diferencia principal entre responsable y encargado?
...
29. ¿Qué documento debe firmarse entre responsable y encargado?
   - a) Código ético
...
30. ¿Qué principio implica tratar solo los datos necesarios?
   - a) Responsabilidad proactiva
   - b) Limitación de la finalidad
   - c) Exactitud
   - d) Minimización
...
31. ¿Qué pasa si el consentimiento se obtiene con casillas premarcadas?
...
32. ¿Qué significa transparencia en el RGPD?
...
33. ¿Cuál de estos no es dato personal?
   - a) Dirección IP
   - b) DNI
...
34. ¿Cuál de los siguientes no es un tratamiento lícito?
...
35. ¿Qué significa limitación del tratamiento?
...
36. ¿Qué debe contener toda política de privacidad para ser válida según el RGPD?
...
37. ¿Qué derecho permite corregir datos inexactos o incompletos?
   - a) Acceso
   - b) Oposición
   - c) Rectificación
   - d) Cancelación
...
38. ¿Cuándo hay alto riesgo en un tratamiento?
...
39. ¿Quién puede presentar reclamaciones ante la AEPD?
   - a) Solo empresas
...
40. ¿Cuál es la sanción máxima por infracciones muy graves?
   - a) 100.000 €
   - b) 500.000 €
   - c) 10 millones o 2%
   - d) 20 millones o 4%
...
41. ¿Plazo máximo para responder a una solicitud de derechos?
   - a) 15 días
   - b) 30 días
...
42. ¿Qué debe hacer un responsable ante una brecha con riesgo para los derechos y libertades?
...
43. ¿Qué derecho permite oponerse al tratamiento por situación particular?
   - a) Supresión
   - b) Portabilidad
   - c) Limitación
   - d) Oposición
...
44. ¿Qué garantiza integridad y confidencialidad?
...
45. ¿Base jurídica para tratar datos de salud en una emergencia sanitaria?
   - a) Interés legítimo
   - b) Consentimiento
...
46. ¿Obligación del encargado del tratamiento?
...
49. ¿Cuándo es necesaria una EIPD?
   - a) Siempre
...
50. ¿Qué significa responsabilidad proactiva?
...
51. ¿Objetivo principal del RGPD?
...
52. ¿Qué se entiende por categorías especiales de datos personales?
...
53. ¿Quién es el responsable del tratamiento según el RGPD?
...
54. ¿Qué principio del artículo 5 RGPD es fundamental?
...
55. ¿Cuándo es lícito el tratamiento de datos personales?
...
56. ¿Qué derecho permite saber si se están tratando tus datos y acceder a ellos?
   - a) Rectificación
   - b) Supresión
   - c) Acceso
   - d) Limitación
...
57. ¿Función principal del Defensor del Pueblo?
   - a) Regular partidos
...
58. ¿Qué organismo es la autoridad de control en España?
   - a) Ministerio de Justicia
   - b) AEPD
...
60. Si un menor no puede consentir el tratamiento de sus datos:
